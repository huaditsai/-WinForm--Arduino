 ...
 */
    public class ArduinoConnect
    {
        ...
        public ArduinoConnect(string serialPortName, Int32 baudRate, bool autoStart, int delay)
        {
        ...
        /// </summary>
        /// <param name="serialPortName">String specifying the name of the serial port. eg COM4</param>
        public ArduinoConnect(string serialPortName) : this(serialPortName, 115200, false, 8000) { }
        ...
        public ArduinoConnect(string serialPortName, Int32 baudRate, bool autostart) : this(serialPortName, baudRate, autostart, 8000) { }
        ...
        /// <param name="serialPortName">String specifying the name of the serial port. eg COM4</param>
        /// <param name="baudRate">Baud rate.</param>
        public ArduinoConnect(string serialPortName, Int32 baudRate) : this(serialPortName, baudRate, false, 8000) { }
        ...
        /// and automatically opens the specified serial connection.
        /// </summary>
        public ArduinoConnect() : this(ArduinoConnect.list().ElementAt(list().Length - 1), 115200, false, 8000) { }
